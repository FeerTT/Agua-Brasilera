...
const AddUserForm = () => {
  ...
  const handleSubmit = (e) => {
    ...
    if (
      !formData.nombre.match(nameRegex) ||
      !formData.apellido.match(nameRegex)
    ) {
      alert(
        "Nombre y apellido deben contener solo letras y espacios, y tener un máximo de 20 caracteres."
      );
      return;
    }
    if (!formData.telefono.match(phoneRegex)) {
      alert(
        "El teléfono debe contener solo números, + o -, y tener un máximo de 25 caracteres."
      );
      return;
    }
